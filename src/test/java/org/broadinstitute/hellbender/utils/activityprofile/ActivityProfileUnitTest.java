...
public class ActivityProfileUnitTest extends BaseTest {
    ...
    public void testBasicActivityProfile(BasicActivityProfileTestProvider cfg) {
        ...
        Assert.assertEquals(genomeLocParser.createGenomeLoc(profile.regionStartLoc), genomeLocParser.createGenomeLoc(cfg.regionStart.getContig(), cfg.regionStart.getStart(), cfg.regionStart.getStart() ), "Start unclippedLoc should be the start of the region");
